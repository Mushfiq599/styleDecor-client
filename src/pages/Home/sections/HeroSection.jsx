...
const HeroSection = () => {
  return (
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
      ...
      >
        <IoFlowerSharp color="#FF69B4" size={26} />
      </motion.div>
      ...
      {/* ── Main content ── */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full flex flex-col items-center justify-center pt-28 sm:pt-20 pb-16">
        ...
        >
          Transform Your
          <br />
          <span className="text-primary">Space</span>{" "}Into
          <br />
          Something{" "}
        ...
        <motion.p
          ...
          animate="visible"
          custom={2}
          className="font-body text-base sm:text-lg text-white/70 max-w-2xl mx-auto mb-8 leading-relaxed"
        >
